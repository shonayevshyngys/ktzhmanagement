...
public class    Repair {
    ...
    public String getVu36_number ()
    {
        return vu36_number;
    }

    public void setVu36_number (String vu36_number)
    {
    ...
    public String getVu23_number ()
    {
        return vu23_number;
    }

    public void setVu23_number (String vu23_number)
    {
    ...
    public int getVagon_no ()
    {
        return vagon_no;
    }

    public void setVagon_no (int vagon_no)
    {
